...
<article style="margin-bottom: 3rem;">
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: start;">
        ...
        <div>
            ...
            <div style="background: var(--surface-elevated); border-left: 4px solid var(--primary); padding: 1.5rem; margin-bottom: 2rem; border-radius: 4px;">
        ...
        <!-- Visual Element -->
        <div style="background: linear-gradient(135deg, var(--secondary-bg) 0%, var(--surface-elevated) 100%); border-radius: var(--card-radius); padding: 2.5rem; height: 100%; min-height: 600px; display: flex; flex-direction: column; justify-content: space-between; border: 1px solid var(--border);">
            <div>
            ...
            <div style="background: var(--accent-light); border-radius: 8px; padding: 1.25rem; border-left: 4px solid var(--primary);">
