    ...
    <div class="slide-container">
        <div class="slide-content" style="display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; min-height: 80vh;">
            <div style="max-width: 1000px;">
                ...
                <div style="font-size: 1.8rem; font-weight: 300; margin-bottom: 1rem; color: #6b7280;">
                    Lộ trình chiến lược 2026
                </div>
                <div style="display: inline-block; background: #f9fafb; border: 2px solid #e5e7eb; border-radius: 12px; padding: 12px 30px; margin-top: 1rem; margin-bottom: 2rem;">
                    <div style="font-size: 1.4rem; font-weight: 600; color: #1f2937;">
                        <span class="material-symbols-rounded" style="font-size: 1.4rem; vertical-align: middle; margin-right: 8px; color: #1f2937;">edit_document</span>
                        Phiên bản 1.0 - Draft đầu tiên
                    </div>
                    <div style="font-size: 0.95rem; color: #6b7280; margin-top: 5px; font-style: italic;">
