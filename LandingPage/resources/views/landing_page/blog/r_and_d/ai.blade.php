    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: start;">
        ...
        <div style="background: linear-gradient(135deg, var(--secondary-bg) 0%, var(--surface-elevated) 100%); border-radius: var(--card-radius); padding: 2.5rem; height: 100%; min-height: 600px; display: flex; flex-direction: column; justify-content: space-between; border: 1px solid var(--border); order: 2;">
            <div>
                ...
                <h4 style="font-size: 1.5rem; font-weight: 600; color: var(--text-dark); margin-bottom: 0.75rem;">{{ __('ai_platform.sidebar_title') }}</h4>
            ...
            <div style="background: var(--surface); border-radius: 10px; padding: 1.75rem; margin-bottom: 1.5rem; border: 1px solid var(--border);">
                <h5 style="font-size: 1rem; font-weight: 600; color: var(--text-dark); margin-bottom: 1.25rem;">{{ __('ai_platform.sidebar_focus_title') }}</h5>
        ...
        <div style="order: 1;">
            ...
            <h3 style="font-size: 1.4rem; font-weight: 600; color: var(--text-dark); margin-bottom: 1rem; margin-top: 2rem;">{{ __('ai_platform.problem_title') }}</h3>
            <p style="color: var(--text-gray); line-height: 1.8; margin-bottom: 1.5rem;">
                {{ __('ai_platform.problem_desc') }}
            </p>

            <h3 style="font-size: 1.4rem; font-weight: 600; color: var(--text-dark); margin-bottom: 1rem; margin-top: 2rem;">{{ __('ai_platform.foundation_title') }}</h3>
            <p style="color: var(--text-gray); line-height: 1.8; margin-bottom: 1.5rem;">
            ...
            <h3 style="font-size: 1.4rem; font-weight: 600; color: var(--text-dark); margin-bottom: 1rem; margin-top: 2rem;">{{ __('ai_platform.impact_title') }}</h3>
            ...
            <h3 style="font-size: 1.4rem; font-weight: 600; color: var(--text-dark); margin-bottom: 1rem; margin-top: 2rem;">{{ __('ai_platform.research_title') }}</h3>
