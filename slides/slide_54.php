...
<div class="slide-container">
  ...
  <div class="slide-content">
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-4"><div class="box"><div class="pro-section-title"><span class="material-symbols-rounded">code_blocks</span>Custom Software</div><ul class="pro-list mb-0"><li><span class="material-symbols-rounded">chevron_right</span><span>Quản lý thủ công</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Dữ liệu phòng ban rời rạc</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Thiếu realtime visibility</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Thiếu dashboard quản trị</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Phụ thuộc Excel</span></li></ul></div></div>
    </div>
