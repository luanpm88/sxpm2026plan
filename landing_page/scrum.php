    ...
    <section style="background: var(--secondary-bg);">
        <div class="container-v5">
            ...
            <div style="display: grid; gap: 3rem;">
                ...
                ?>
                <div style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: flex-start;">
                    <div style="position: relative;">
                        <div style="width: 100px; height: 100px; background: white; border: 2px solid var(--primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; text-align: center; flex-direction: column;">
                            <div style="font-size: 1.5rem; font-weight: 800; color: var(--primary);">Phase <?php echo $index + 1; ?></div>
                        </div>
                        <?php if ($index < count($journey) - 1): ?>
                        <div style="position: absolute; top: 100px; left: 50%; width: 2px; height: 100px; background: linear-gradient(to bottom, var(--primary), transparent); transform: translateX(-50%);"></div>
                        <?php endif; ?>
                    </div>
