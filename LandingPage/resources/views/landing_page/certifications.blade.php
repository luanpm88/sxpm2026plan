    ...
    <section id="compliance">
        <div class="container-v5">
            ...
            <div class="card-grid" style="--card-min: 280px; --card-max: 420px; --card-gap: 2rem;">
                ...
                <div style="background: var(--surface); border-radius: var(--card-radius); padding: 2.5rem 2rem; border: 1px solid var(--border); transition: all 0.3s ease; text-align: center;" onmouseover="this.style.borderColor='var(--primary)'; this.style.boxShadow='0 10px 30px rgba(24, 48, 96, 0.1)'; this.style.transform='translateY(-4px)';" onmouseout="this.style.borderColor='var(--border)'; this.style.boxShadow=''; this.style.transform='';">
                    <div style="font-size: 2rem; color: var(--primary); margin-bottom: 1rem;">
                        <span class="material-symbols-rounded">{{ $cert['icon'] }}</span>
                    </div>
                    <h3 style="font-size: 1.1rem; font-weight: 600; color: var(--text-dark); margin-bottom: 0.5rem;">{{ $cert['name'] }}</h3>
    ...
    <section style="background: var(--secondary-bg);">
        <div class="container-v5">
            ...
            <div class="card-grid" style="--card-min: 280px; --card-max: 420px; --card-gap: 2rem;">
                ...
                <div style="background: var(--surface); border-radius: var(--card-radius); padding: 2rem; border: 1px solid var(--border); transition: all 0.3s ease;" onmouseover="this.style.borderColor='var(--primary)'; this.style.boxShadow='0 10px 30px rgba(24, 48, 96, 0.1)';" onmouseout="this.style.borderColor='var(--border)'; this.style.boxShadow='';">
                    <div style="font-size: 2rem; color: var(--primary); margin-bottom: 1rem;">
                        <span class="material-symbols-rounded">{{ $cloud['icon'] }}</span>
                    </div>
                    <h3 style="font-size: 1.15rem; font-weight: 600; color: var(--text-dark); margin-bottom: 1.5rem;">{{ $cloud['provider'] }}</h3>
            ...
            <div class="card-grid" style="--card-min: 300px; --card-max: 440px; --card-gap: 2rem;">
                ...
                <div style="background: var(--surface); border-radius: var(--card-radius); padding: 2.5rem 2rem; border: 2px solid #e2e8f0; transition: all 0.3s ease;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateX(5px)';" onmouseout="this.style.borderColor='#e2e8f0'; this.style.transform='';">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">
                        ...
                        <h3 style="font-size: 1.15rem; font-weight: 600; color: var(--text-dark); margin: 0;">{{ $cat['category'] }}</h3>
                    </div>
                    <ul style="list-style: none; padding: 0; margin: 0;">
    ...
    <section style="background: var(--secondary-bg);">
        <div class="container-v5">
            ...
            <div class="card-grid" style="--card-min: 280px; --card-max: 420px; --card-gap: 2rem;">
                ...
                <div style="background: var(--surface); border-radius: var(--card-radius); padding: 2rem; border: 1px solid var(--border); transition: all 0.3s ease;" onmouseover="this.style.boxShadow='0 8px 20px rgba(24, 48, 96, 0.1)';" onmouseout="this.style.boxShadow='';">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">
                        <div style="font-size: 2rem; color: var(--primary);">
                            <span class="material-symbols-rounded">{{ $tech['icon'] }}</span>
                        </div>
                        <h3 style="font-size: 1rem; font-weight: 600; color: var(--text-dark); margin: 0;">{{ $tech['category'] }}</h3>
                    </div>
                    <ul style="list-style: none; padding: 0; margin: 0;">
    ...
    <section>
        <div class="container-v5">
            ...
            <div class="card-grid" style="--card-min: 280px; --card-max: 420px; --card-gap: 2rem;">
                ...
                <div style="background: var(--surface); border-radius: var(--card-radius); padding: 2.5rem 2rem; border: 1px solid var(--border); text-align: center; transition: all 0.3s ease;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateY(-5px)'; this.style.boxShadow='0 10px 30px rgba(24, 48, 96, 0.1)';" onmouseout="this.style.borderColor='var(--border)'; this.style.transform=''; this.style.boxShadow='';">
                    <div style="font-size: 2rem; color: var(--primary); margin-bottom: 1rem;">
                        <span class="material-symbols-rounded">{{ $profile['icon'] }}</span>
                    </div>
                    <h3 style="font-size: 1.1rem; font-weight: 600; color: var(--text-dark); margin-bottom: 0.5rem;">{{ $profile['title'] }}</h3>
                    <p style="font-size: 2rem; font-weight: 600; color: var(--primary); margin: 0.75rem 0;">{{ $profile['count'] }}</p>
    ...
    <section style="background: var(--secondary-bg);">
        <div class="container-v5">
            <div style="background: var(--contrast-panel-bg); border-radius: var(--card-radius); padding: 3.5rem 2rem; text-align: center; color: var(--contrast-panel-text);">
                <h2 style="font-size: 2rem; font-weight: 600; margin-bottom: 1rem;">{{ __('certifications.learning_title') }}</h2>
                ...
                <div class="card-grid" style="--card-min: 200px; --card-max: 340px; --card-gap: 2rem; max-width: 1200px; margin: 0 auto;">
                    <div style="background: var(--contrast-decoration-bg); border-radius: 8px; padding: 1.5rem;">
                        <div style="font-size: 2rem; font-weight: 600; margin-bottom: 0.5rem;">{{ __('certifications.learning_stat1_value') }}</div>
                        <div style="font-size: 0.9rem;">{{ __('certifications.learning_stat1_label') }}</div>
                    </div>
                    <div style="background: var(--contrast-decoration-bg); border-radius: 8px; padding: 1.5rem;">
                        <div style="font-size: 2rem; font-weight: 600; margin-bottom: 0.5rem;">{{ __('certifications.learning_stat2_value') }}</div>
                        <div style="font-size: 0.9rem;">{{ __('certifications.learning_stat2_label') }}</div>
                    </div>
                    <div style="background: var(--contrast-decoration-bg); border-radius: 8px; padding: 1.5rem;">
                        <div style="font-size: 2rem; font-weight: 600; margin-bottom: 0.5rem;">{{ __('certifications.learning_stat3_value') }}</div>
                        <div style="font-size: 0.9rem;">{{ __('certifications.learning_stat3_label') }}</div>
                    </div>
                    <div style="background: var(--contrast-decoration-bg); border-radius: 8px; padding: 1.5rem;">
                        <div style="font-size: 2rem; font-weight: 600; margin-bottom: 0.5rem;">{{ __('certifications.learning_stat4_value') }}</div>
