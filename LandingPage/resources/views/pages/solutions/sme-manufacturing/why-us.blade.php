    ...
    <div class="container-v5">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem;">
            @foreach(__('sme_manufacturing.why_us_items') as $item)
                <div style="background: #fff; border: 1px solid var(--border); border-radius: var(--card-radius); padding: 1.5rem;">
        ...
        <div style="margin-top: 1rem; background: #fff; border: 1px solid var(--border); border-radius: var(--card-radius); padding: 1.5rem;">
