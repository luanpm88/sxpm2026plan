    ...
    <section style="background: var(--secondary-bg);">
        <div class="container-v5">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 2rem;">
                <?php
                $process = [
                    ['num' => 1, 'title' => 'Discovery', 'desc' => 'Hiểu rõ goals, analyze requirements, market research'],
                    ['num' => 2, 'title' => 'Design', 'desc' => 'Architecture, wireframes, data models, tech planning'],
                    ['num' => 3, 'title' => 'Development', 'desc' => 'Sprint-based delivery, code review, CI/CD'],
                    ['num' => 4, 'title' => 'Testing', 'desc' => 'QA, performance testing, security scanning'],
                    ['num' => 5, 'title' => 'Deployment', 'desc' => 'Production release, monitoring setup'],
                    ['num' => 6, 'title' => 'Support', 'desc' => '24/7 support, optimization, scaling'],
                ];
                foreach ($process as $p):
                ?>
                <div style="background: white; border-radius: 12px; padding: 2rem; border: 1px solid var(--border); text-align: center;">
                    <div style="display: inline-flex; align-items: center; justify-content: center; width: 45px; height: 45px; background: var(--primary); color: white; border-radius: 50%; font-weight: 800; font-size: 1.3rem; margin-bottom: 1rem;">
                        <?php echo $p['num']; ?>
                    </div>
                    <h3 style="font-size: 1.1rem; font-weight: 700; color: var(--text-dark); margin-bottom: 0.75rem;">
                        <?php echo $p['title']; ?>
