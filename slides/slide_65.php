...
<div class="slide-container">
  <div class="slide-header">
    ...
    <div class="slide-subtitle">Năng lực thật hiện tại để tiếp cận FDI manufacturing, tránh kỳ vọng vượt khả năng</div>
  </div>
  <div class="slide-content">
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-6"><div class="cardx"><div class="pro-section-title"><span class="material-symbols-rounded">warning</span>Current constraints</div><ul class="pro-list mb-0"><li><span class="material-symbols-rounded">chevron_right</span><span>Chưa có SME vertical product chạy production end-to-end</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Thiếu reference case FDI manufacturing tại KCN</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Domain playbook chuyên sâu theo ngành còn cần chuẩn hóa</span></li></ul></div></div>
