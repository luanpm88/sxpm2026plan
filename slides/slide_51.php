...
<div class="slide-container">
  ...
  <div class="slide-content">
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-6"><div class="cardx"><div class="pro-section-title"><span class="material-symbols-rounded">factory</span>Priority industries</div><ul class="pro-list mb-0"><li><span class="material-symbols-rounded">chevron_right</span><span>Điện - điện tử</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Linh kiện ô tô</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Công nghiệp phụ trợ</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Sản xuất tiêu dùng quy mô lớn</span></li><li><span class="material-symbols-rounded">chevron_right</span><span>Thiết bị công nghiệp & chế tạo</span></li></ul></div></div>
    </div>
    <div class="band"><strong>3 business pillars của công ty:</strong> Cung cấp thiết bị phần cứng, giải pháp hạ tầng CNTT, phần mềm tùy chỉnh. <strong>Thứ tự ưu tiên triển khai:</strong> FDI sản xuất trong KCN phía Nam làm trước, sau đó mở rộng.</div>
  </div>
</div>
