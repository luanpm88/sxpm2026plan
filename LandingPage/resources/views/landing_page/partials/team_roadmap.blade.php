<div class="team-roadmap">
    ...
    <h3 style="text-align:center;color:var(--primary);font-weight: 600;margin-bottom:18px;">{{ __('team_roadmap.title') }}</h3>
...
.team-card h4 { color: var(--primary); font-size: 1rem; font-weight: 600; margin-bottom: 8px; }
