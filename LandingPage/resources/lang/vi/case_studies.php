...
return [
    ...
    'hero_desc' => 'Một số dự án tiêu biểu thể hiện cách Hoàng Khang Incotech tiếp cận bài toán hệ thống doanh nghiệp: hiểu bối cảnh, thiết kế kiến trúc, triển khai có kiểm soát và bàn giao để vận hành lâu dài.',
    ...
    'case_studies' => [
        [
            ...
            'solution' => 'Hoàng Khang Incotech xây dựng nền tảng vận hành giáo dục với API trung tâm, cơ chế lập lịch linh hoạt, quy tắc phân bổ tải, điểm danh tự động và báo cáo theo vai trò. Hạ tầng được thiết kế để xử lý các giai đoạn cao điểm như tuyển sinh và xếp lịch đầu kỳ.',
            'results' => [
        ...
        [
            ...
            'solution' => 'Hoàng Khang Incotech xây dựng hệ thống quản lý kho với quét mã vạch, đồng bộ dữ liệu nhiều địa điểm, đối soát tự động và báo cáo phân tích. Các mô hình dự báo được triển khai để hỗ trợ lập kế hoạch tồn kho và giảm thao tác thủ công.',
            'results' => [
        ...
        [
            ...
            'solution' => 'Hoàng Khang Incotech xây dựng nền tảng ERP tích hợp kế toán, tồn kho, mua hàng, thương mại điện tử, nhân sự và báo cáo quản trị. Hệ thống bổ sung đồng bộ dữ liệu, bảng điều khiển BI, tự động hóa quy trình và ứng dụng di động cho đội hiện trường.',
            'results' => [
    ...
    'industries' => [
        ...
        ['icon' => 'trending_up', 'name' => 'FinTech & Dịch Vụ Tài Chính', 'description' => 'Luồng thanh toán, bảng điều khiển quản trị, báo cáo và kiểm soát dữ liệu.'],
    ...
    'testimonials_subtitle' => 'Góc nhìn từ các đội ngũ đã cùng Hoàng Khang Incotech triển khai hệ thống.',

    'testimonials' => [
        ['name' => 'CEO, doanh nghiệp thương mại điện tử', 'text' => 'Hoàng Khang Incotech không chỉ nhận yêu cầu rồi triển khai. Đội ngũ đặt câu hỏi đúng, đề xuất cải tiến và giữ tiến độ rất rõ ràng.'],
        ['name' => 'Nhà sáng lập, công ty FinTech', 'text' => 'Cách tiếp cận bảo mật và kiểm soát dữ liệu giúp chúng tôi chuẩn hóa hệ thống ngay từ giai đoạn đầu.'],
    ...
    'cta_desc' => 'Hoàng Khang Incotech có thể cùng đội ngũ của bạn làm rõ phạm vi, rủi ro kỹ thuật và lộ trình triển khai phù hợp.',
