        ...
        <div class="hero-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center;">
            <div class="hero-content">
                <h1 style="font-size: 4rem; font-weight: 800; line-height: 1.15; margin-bottom: 1.5rem; color: var(--text-dark);">
                    {{ __('hero.title_line1') }}<br><span style="color: var(--primary);">{{ __('hero.title_line2') }}</span>
                </h1>
                ...
                <div class="hero-stats" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem; margin-top: 3rem; padding-top: 2.5rem; border-top: 1px solid var(--border);">
                    <div>
                        <div style="font-size: 2.25rem; font-weight: 800; color: var(--primary);">{{ __('hero.stat1_value') }}</div>
                        <div style="font-size: 0.95rem; color: var(--text-gray); margin-top: 0.5rem;">{{ __('hero.stat1_label') }}</div>
                    </div>
                    <div>
                        <div style="font-size: 2.25rem; font-weight: 800; color: var(--primary);">{{ __('hero.stat2_value') }}</div>
                        <div style="font-size: 0.95rem; color: var(--text-gray); margin-top: 0.5rem;">{{ __('hero.stat2_label') }}</div>
                    </div>
                    <div>
                        <div style="font-size: 2.25rem; font-weight: 800; color: var(--primary);">{{ __('hero.stat3_value') }}</div>
                        <div style="font-size: 0.95rem; color: var(--text-gray); margin-top: 0.5rem;">{{ __('hero.stat3_label') }}</div>
                    </div>
                </div>
            </div>
